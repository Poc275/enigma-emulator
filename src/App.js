...
function App() {
  ...
  const encipher = (event) => {
    console.log(event.key);
    const result = enigma.encipher(event.key);
  ...
  return (
    <>
      ...
      <div>
        <p>Enter message</p>
        <textarea id="input" name="input" rows="10" cols="35" onKeyDown={encipher} disabled></textarea>
      </div>
